    ...
    let(:snapshot) do
      <<~HTML
        <div class="buttons is-right is-gapless">
          <a class="button has-text-info is-borderless is-shadowless m-0 p-0 px-1" href="/tasks/source_task/relationships/00000000-0000-0000-0000-000000000000">
            Show
          </a>

          <a class="button has-text-warning is-borderless is-shadowless m-0 p-0 px-1" href="/tasks/source_task/relationships/00000000-0000-0000-0000-000000000000/edit">
            Update
          </a>
