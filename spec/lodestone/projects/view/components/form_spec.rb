...
RSpec.describe Lodestone::Projects::View::Components::Form, type: :component do
  ...
  describe '#call' do
    ...
    describe 'with action_name: :update' do
      ...
      let(:routes) do
        super().with_wildcards({ id: 'ex-app' })
      end
      let(:snapshot) do
        <<~HTML
          <form class="fixed-grid has-6-cols" action="/projects/ex-app" accept-charset="UTF-8" method="post">
            ...
            <div class="grid">
              ...
              <div class="field is-grouped cell is-col-span-6">
                ...
                <p class="control">
                  <a class="button" href="/projects/ex-app">
                    Cancel
                  </a>
                </p>
              </div>
