    ...
    let(:snapshot) do
      <<~HTML
        <div class="buttons is-right is-gapless">
          <a class="button has-text-success is-borderless is-shadowless mx-0 px-1 py-0" href="/projects/example-project/board">
            Board
          </a>

          <a class="button has-text-info is-borderless is-shadowless mx-0 px-1 py-0" href="/projects/example-project">
            Show
          </a>

          <a class="button has-text-warning is-borderless is-shadowless mx-0 px-1 py-0" href="/projects/example-project/edit">
            Update
          </a>
